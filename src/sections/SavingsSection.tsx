...
export default function SavingsSection() {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/installer_rooftop_wide.jpg"
          alt="Installer on rooftop"
      ...
      >
        ...
        <h2 className="content-item text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white max-w-lg leading-tight">
          Lower bills. Stronger returns.
        </h2>
        <p className="content-item mt-6 text-base sm:text-lg text-white/80 max-w-md leading-relaxed">
          We size your system for real-world production and protect you from rising tariffs—so your savings grow year after year.
        </p>
        <button
      ...
      >
        <span className="text-4xl sm:text-5xl lg:text-6xl font-bold text-solar-navy">25–35%</span>
        <p className="mt-3 text-sm sm:text-base text-solar-gray">
          Typical lifetime savings vs. grid
        </p>
      </div>
    </section>
  );
